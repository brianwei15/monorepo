...
def launch_setup(context, *args, **kwargs):
    ...
    GZ_CAMERA_TOPIC = (
        f"/world/{competition}/model/{model[3:]}_1/link/camera_link/sensor/camera/image"
    )
    GZ_CAMERA_INFO_TOPIC = f"/world/{competition}/model/{model[3:]}_1/link/camera_link/sensor/camera/camera_info"
